      ...
      <section className="py-16 bg-cream-50">
        <div className="container-wide grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-1 space-y-6">
            <TempleLocation showMap={false} compact />
            ...
            <div className="bg-white p-6 rounded-lg border border-cream-200 shadow-soft">
              ...
              <a
                ...
                className="text-sm text-stone-700 hover:text-saffron-700 font-medium"
              >
                {siteConfig.phoneDisplay}
              </a>
              <div className="mt-4">
                <SocialCTAs layout="row" showContact={false} />
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg border border-cream-200 shadow-soft">
              ...
              <a
                ...
                className="text-sm text-stone-700 hover:text-saffron-700"
              >
                {siteConfig.contactEmail}
              </a>
            </div>

            <div className="bg-saffron-50 p-6 rounded-lg border border-saffron-200">
              <h3 className="font-display text-lg text-saffron-900 mb-2">Invite for Katha</h3>
              <p className="text-sm text-stone-600 mb-4 font-serif leading-relaxed">
                To invite Shri Pundrik Goswami Ji for Katha, Pravachan, or Sankirtan, please use
                the dedicated request form.
              </p>
              <Link to="/katha-request">
                <Button variant="primary" fullWidth>
                  Request Katha <ExternalLink className="w-4 h-4" />
                </Button>
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-6 sm:p-8 rounded-lg border border-cream-200 shadow-soft">
            ...
            <TempleLocation showMap compact />
          </div>
        </div>
      </section>
    </>
